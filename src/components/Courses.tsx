    ...
    <Link to={`/course/${course?._id}`}>
      <div className=" w-[300px] h-[300px] bg-white shadow-lg flex flex-col items-center rounded py-4 px-4">
        <div className=" w-full h-[160px]">
          <img className="h-[160px]" src={course?.imageLink} alt="courseImage" />
        </div>
        <div className="text-xl font-semibold w-full line-clamp-1 py-1">{course?.title}</div>
        ...
        <div className="font-semibold text-lg w-full">₹5999</div>
      </div>
    </Link>
  );
};
